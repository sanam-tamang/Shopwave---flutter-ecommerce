...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, description: $description, price: $price, discountPrice: $discountPrice, images: $images, stockQuantity: $stockQuantity)';
  }
...
abstract class _Product implements Product {
  const factory _Product(
          ...
          required final List<ProductImage> images,
          @JsonKey(name: "quantity") required final int stockQuantity}) =
      _$ProductImpl;
